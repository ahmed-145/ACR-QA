...
class SCAScanner:
    ...
    def _scan_requirements(self) -> List[Dict]:
        ...
        KNOWN_VULNERABLE = {
            "requests": {"below": "2.31.0", "vuln": "CVE-2023-32681", "desc": "Unintended leak of Proxy-Authorization header"},
            "urllib3": {"below": "2.0.7", "vuln": "CVE-2023-45803", "desc": "Cookie header leak on redirect"},
            "flask": {"below": "2.3.2", "vuln": "CVE-2023-30861", "desc": "Session cookie security bypass"},
            "cryptography": {"below": "41.0.0", "vuln": "CVE-2023-38325", "desc": "X.509 certificate verification bypass"},
            "pillow": {"below": "10.0.1", "vuln": "CVE-2023-44271", "desc": "DoS via large TIFF file"},
            "django": {"below": "4.2.4", "vuln": "CVE-2023-41164", "desc": "Potential denial-of-service"},
            "pyyaml": {"below": "6.0.1", "vuln": "CVE-2020-14343", "desc": "Arbitrary code execution via yaml.load"},
        }

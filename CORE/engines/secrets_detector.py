...
class SecretsDetector:
    ...
    PATTERNS = [
        # AWS
        ("AWS Access Key", r'(?:AKIA|ASIA)[A-Z0-9]{16}', "high",
         "AWS Access Key ID detected"),
        ("AWS Secret Key", r'(?i)aws[_\-]?secret[_\-]?(?:access)?[_\-]?key\s*[=:]\s*["\']?([A-Za-z0-9/+=]{40})', "high",
         "AWS Secret Access Key detected"),
        
        # Google
        ("Google API Key", r'AIza[A-Za-z0-9\-_]{35}', "high",
        ...
        ("GitHub OAuth", r'(?i)github[_\-]?(?:oauth|token|secret)\s*[=:]\s*["\']?([a-f0-9]{40})', "high",
         "GitHub OAuth secret detected"),
        
        # Generic API Keys
        ("API Key Assignment", r'(?i)(?:api[_\-]?key|apikey|api_secret)\s*[=:]\s*["\']([A-Za-z0-9\-_]{20,})["\']', "high",
         "Hardcoded API key detected"),
        
        # Passwords
        ("Password Assignment", r'(?i)(?:password|passwd|pwd|pass)\s*[=:]\s*["\']([^"\']{6,})["\']', "high",
         "Hardcoded password detected"),
        ("Database URL with Password", r'(?i)(?:postgres|mysql|mongodb|redis)://[^:]+:([^@]+)@', "high",
        ...
        ("Auth Token", r'(?i)(?:auth[_\-]?token|access[_\-]?token|secret[_\-]?token)\s*[=:]\s*["\']([A-Za-z0-9\-_\.]{20,})["\']', "high",
        ...
        # Slack
        ("Slack Token", r'xox[bpors]-[0-9]{10,13}-[a-zA-Z0-9-]{20,}', "high",
        ...
        # Generic secrets
        ("Secret Assignment", r'(?i)(?:secret|private[_\-]?key|encryption[_\-]?key)\s*[=:]\s*["\']([A-Za-z0-9\-_\.]{16,})["\']', "medium",
         "Hardcoded secret value detected"),
        
        # Stripe
        ("Stripe Key", r'(?:sk|pk)_(?:live|test)_[A-Za-z0-9]{24,}', "high",
        ...
        # Twilio
        ("Twilio Key", r'SK[a-f0-9]{32}', "medium",
         "Twilio API key detected"),
    ]
    
    # Files/directories to skip
    SKIP_PATTERNS = [
        r'\.git/', r'__pycache__/', r'\.venv/', r'venv/',
        r'node_modules/', r'\.env\.example', r'\.env\.sample',
        r'.*\.pyc$', r'.*\.lock$', r'.*\.min\.js$',
    ]
